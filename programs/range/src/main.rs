...
use op_succinct_client_utils::{
    boot::BootInfoStruct, core_client::run_opsuccinct_core_client, precompiles::zkvm_handle_register
};
...
fn main() {
    ...
    kona_proof::block_on(async move {
        ...
        let witness: EigenDABlobWitnessData = serde_cbor::from_slice(&oracle.witness.as_ref().unwrap()).expect("cannot deserialize eigenda witness");
